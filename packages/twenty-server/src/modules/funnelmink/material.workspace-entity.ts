...
export class MaterialWorkspaceEntity extends BaseWorkspaceEntity {
  @WorkspaceField({
    standardId: MATERIAL_STANDARD_FIELD_IDS.name,
  ...
  @WorkspaceField({
    standardId: MATERIAL_STANDARD_FIELD_IDS.description,
    type: FieldMetadataType.TEXT,
    label: 'Description',
  ...
  @WorkspaceRelation({
    ...
    label: 'Jobs',
    description: 'Jobs utilizing this Material',
  ...
  @WorkspaceRelation({
    ...
    label: 'Activities',
    description: 'Activities tied to the Material',
