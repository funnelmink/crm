  ...
  return (
    <>
      <ContentContainer>
        ...
        <h2>Introduction</h2>
        <p>
          Herein are the Terms of Service that govern the use of products
          (“Service” or “Services”) created by FunnelMink, LLC (“Company”, “we”,
          “our”, “us”). The estimated reading time for the full content is
          approximately 20 minutes. These Terms of Service (“Terms”, “Terms of
          Service”) govern the use of our main website on{' '}
          <a href="https://funnelmink.com">funnelmink.com</a> and any of its
          sub-domain, as well as any mobile application (together or
          individually “Service”) operated by FunnelMink, LLC. Our Privacy
          ...
          of our web pages. Please read it at:{' '}
          <a href="https://funnelmink.com/privacy">
            https://funnelmink.com/privacy
          </a>
          . Your agreement with us includes these Terms and our Privacy Policy
          (“Agreements”). You acknowledge that you have read and understood
          Agreements and agree to them. If you do not agree with (or cannot
          comply with) Agreements, then you may not use the Service, but please
          let us know by emailing at info@funnelmink.com so we can try to find a
        ...
        <p>
          ...
          conditions unless you cancel it or FunnelMink, LLC cancels it. You may
          cancel your Subscription renewal either through your online account
          management page or by contacting FunnelMink, LLC customer support
          team. A valid payment method, including credit card, is required to
          process the payment for your subscription. You shall provide
          FunnelMink, LLC with accurate and complete billing information
          ...
          information, you automatically authorize FunnelMink, LLC to charge all
          ...
          FunnelMink, LLC will issue an electronic invoice indicating that you
        ...
        <h2>Free Trial</h2>
        <p>
          FunnelMink, LLC may, at its sole discretion, offer a Subscription with
          ...
          for Free Trial, you will not be charged by FunnelMink, LLC until Free
          ...
          selected. At any time and without notice, FunnelMink, LLC reserves the
          right to (i) modify Terms of Service of Free Trial offer, or (ii)
          cancel such Free Trial offer.
        </p>
        <h2>Fee Changes</h2>
        <p>
          FunnelMink, LLC, in its sole discretion and at any time, may modify
          ...
          FunnelMink, LLC will provide you with a reasonable prior notice of any
        ...
        <p>
          ...
          Terms. FunnelMink, LLC has the right but not the obligation to monitor
        ...
        <p>
          ...
          property of FunnelMink, LLC and its licensors. Service is protected by
          ...
          product or service without the prior written consent of Funnelmink,
          LLC.
        </p>
        <h2>Error Reporting and Feedback</h2>
        <p>
          You may provide us either directly at info@funnelmink.com or via third
          ...
          and commercialize) Feedback in any manner and for any purpose. The
        ...
        <p>
          ...
          are not owned or controlled by FunnelMink, LLC FunnelMink, LLC has no
          ...
          their websites. YOU ACKNOWLEDGE AND AGREE THAT FUNNELMINK, LLC SHALL
        ...
        <p>
          ...
          laws of State of Utah without regard to its conflict of law
        ...
        <p>
          ...
          Your continued use of our platform following the posting of revised
